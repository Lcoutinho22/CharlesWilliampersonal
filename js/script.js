document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedTheme === 'light') {
        ...
        if (logo) logo.src = './image/logo-clara.jpeg';
        if (icon) icon.classList.replace('fa-sun', 'fa-moon');
    } else {
        body.classList.remove('light-theme');
        if (logo) logo.src = './image/logo-escura.jpeg';
...
function toggleTheme() {
    ...
    if (body.classList.contains('light-theme')) {
        ...
        function agendarWhatsApp() {
            ...
            const objetivo = document.getElementById('clientObjective').value;
            ...
            let msg = `Olá Charles! Gostaria de iniciar meu treinamento:%0A%0A*Nome:* ${nome} (${idade} anos)%0A*Experiência:* ${nivelSelected}%0A*Objetivo:* ${objetivo}%0A*Plano:* ${servico}%0A*Previsão:* ${dataF} - ${hora}`;
        ...
        const translations = {
            pt: {
                ...
                spec_hyper: "Hipertrofia",
                spec_weight: "Emagrecimento",
                spec_def: "Definição Muscular",
                spec_quality: "Qualidade de Vida",
                spec_cond: "Condicionamento",
                spec_elderly: "Terceira Idade",
                spec_hiit: "HIIT",
                spec_func: "Funcional",
                about_p1: "Bacharel em Educação Física focado em Saúde, Bem-Estar e Esportes. Especialista em planejamento e execução de treinos personalizados, com amplo conhecimento em fisiologia do exercício e biomecânica.",
                about_p2: "Meu objetivo é promover a qualidade de vida e o desempenho físico, ajudando você a alcançar seus objetivos através de motivação e ciência aplicada ao movimento.",
                ...
                card_bimestral_name: "Consultoria Bimestral",
                card_trimestral_name: "Consultoria Trimestral",
                per_month: "/mês",
                per_2months: "/2 meses",
                per_3months: "/3 meses",
                ...
                opt_bimestral: "Consultoria Bimestral",
                opt_trimestral: "Consultoria Trimestral",
            ...
            en: {
                ...
                spec_hyper: "Hypertrophy",
                spec_weight: "Weight Loss",
                spec_def: "Muscle Definition",
                spec_quality: "Quality of Life",
                spec_cond: "Conditioning",
                spec_elderly: "Elderly Care",
                spec_hiit: "HIIT",
                spec_func: "Functional",
                about_p1: "Bachelor in Physical Education focused on Health, Wellness and Sports. Specialist in planning and executing personalized training, with broad knowledge in exercise physiology and biomechanics.",
                about_p2: "My goal is to promote quality of life and physical performance, helping you achieve your goals through motivation and science applied to movement.",
                ...
                card_bimestral_name: "2-Month Consulting",
                card_trimestral_name: "3-Month Consulting",
                per_month: "/month",
                per_2months: "/2 months",
                per_3months: "/3 months",
                ...
                opt_bimestral: "2-Month Consulting",
                opt_trimestral: "3-Month Consulting",
            ...
            es: {
                ...
                spec_hyper: "Hipertrofia",
                spec_weight: "Pérdida de Peso",
                spec_def: "Definición Muscular",
                spec_quality: "Calidad de Vida",
                spec_cond: "Condicionamiento",
                spec_elderly: "Tercera Edad",
                spec_hiit: "HIIT",
                spec_func: "Funcional",
                ...
                card_bimestral_name: "Asesoría Bimestral",
                card_trimestral_name: "Asesoría Trimestral",
                per_month: "/mes",
                per_2months: "/2 meses",
                per_3months: "/3 meses",
                ...
                feat_biomechanics: "Corrección Biomecânica",
                ...
                opt_bimestral: "Asesoría Bimestral",
                opt_trimestral: "Asesoría Trimestral",
